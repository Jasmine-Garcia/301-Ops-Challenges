...
print("Time spent by normal processes executing in kernel mode:", kernel_time)
...
print("Time spent by priority processes executing in user mode:", priority_time)

# Time spent waiting for I/O to complete.
IO_time = psutil.cpu_times().iowait
print("Time spent waiting for I/0 to complete:", IO_time)

# Time spent for servicing hardware interrupts
servicing_hardware_time = psutil.cpu_times().irq
print("Time spent for servicing hardware interrupts:", servicing_hardware_time)
      
# Time spent for servicing software interrupts
servicing_software_time = psutil.cpu_times().softirq
print("Time spent sevicing software interrupts:", servicing_software_time)
      
# Time spent by other operating systems running in a virtualized environment
virtualization_time = psutil.cpu_times().steal
print("Time spent by other operating systems running in a virtualized environment:", virtualization_time)

# Time spent running a virtual CPU for guest operating systems under the control of the Linux kernel
linux_time = psutil.cpu_times().guest
print("Time spent running a virtual CPU for guest operating systems under the control of the Linux kernel:", linux_time)
